...
const AssortmentGroupEdit = props => {
	...
	return (
		<>
			...
			<SingleDetail title="Dane dotyczące grupy asortymentowej" type="edit" handleSave={handleSave} handleDelete={handleDelete}>
				<React.Fragment>
...
export default AssortmentGroupEdit;
